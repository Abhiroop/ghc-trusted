...
GhcRtsWithLibdw=$(strip $(if $(filter $(TargetArch_CPP),i386 x86_64),NO,NO))
...
CC              = gcc
CC_STAGE0       = x86_64-linux-gnu-gcc
CC_STAGE1       = $(CC)
CC_STAGE2       = $(CC)
CC_STAGE3       = $(CC)

AS              = gcc
AS_STAGE0       = x86_64-linux-gnu-gcc
AS_STAGE1       = $(AS)
AS_STAGE2       = $(AS)
AS_STAGE3       = $(AS)

# why no LD=ld.gold ?
LD_STAGE0       = x86_64-linux-gnu-ld.gold
LD_STAGE1       = $(LD)
LD_STAGE2       = $(LD)
LD_STAGE3       = $(LD)
...
CPP			= gcc -E 
HS_CPP			= gcc -E -undef -traditional
...
CONFIGURE_ARGS =  '--with-intree-gmp' '--disable-large-address-space'
