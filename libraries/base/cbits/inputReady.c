...
// ABHI: Added for the nanosleep call
#include <time.h>
/*
...
{
  // ABHI: As I have stubbed out this fairly complex logic,
  // I will defensively wait for `msecs` msec plus a short
  // buffer time before returning 1.
  int64_t buffer_msec = 50; //50 msec buffer time
  //see latency for 1MB seq disk read https://gist.github.com/jboner/2841832
  int64_t milliseconds = msecs + buffer_msec;
