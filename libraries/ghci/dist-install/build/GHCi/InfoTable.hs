...
{-# LINE 94 "libraries/ghci/GHCi/InfoTable.hsc" #-}
       ArchX86_64
...
{-# LINE 326 "libraries/ghci/GHCi/InfoTable.hsc" #-}
...
{-# LINE 330 "libraries/ghci/GHCi/InfoTable.hsc" #-}

{-# LINE 336 "libraries/ghci/GHCi/InfoTable.hsc" #-}
...
{-# LINE 366 "libraries/ghci/GHCi/InfoTable.hsc" #-}
        return (castPtrToFunPtr (ex_ptr `plusPtr` conInfoTableSizeB))

{-# LINE 370 "libraries/ghci/GHCi/InfoTable.hsc" #-}
