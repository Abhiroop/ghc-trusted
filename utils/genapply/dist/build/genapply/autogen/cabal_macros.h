...
/* package genapply-0.1 */
#ifndef VERSION_genapply
#define VERSION_genapply "0.1"
#endif /* VERSION_genapply */
#ifndef MIN_VERSION_genapply
#define MIN_VERSION_genapply(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_genapply */
...
#define CURRENT_COMPONENT_ID "genapply-0.1-genapply"
