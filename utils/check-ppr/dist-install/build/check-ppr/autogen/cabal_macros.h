...
/* package check-ppr-0.1 */
#ifndef VERSION_check_ppr
#define VERSION_check_ppr "0.1"
#endif /* VERSION_check_ppr */
#ifndef MIN_VERSION_check_ppr
#define MIN_VERSION_check_ppr(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_check_ppr */
...
#define CURRENT_COMPONENT_ID "check-ppr-0.1-check-ppr"
