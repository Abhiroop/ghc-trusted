...
/* package runghc-8.8.2 */
#ifndef VERSION_runghc
#define VERSION_runghc "8.8.2"
#endif /* VERSION_runghc */
#ifndef MIN_VERSION_runghc
#define MIN_VERSION_runghc(major1,major2,minor) (\
  (major1) <  8 || \
  (major1) == 8 && (major2) <  8 || \
  (major1) == 8 && (major2) == 8 && (minor) <= 2)
#endif /* MIN_VERSION_runghc */
...
#define CURRENT_COMPONENT_ID "runghc-8.8.2-runghc"
