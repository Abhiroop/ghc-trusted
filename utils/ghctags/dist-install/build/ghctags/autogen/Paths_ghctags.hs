...
libdir     = "/usr/local/lib/x86_64-linux-ghc-8.8.2/ghctags-0.1-ghctags"
dynlibdir  = "/usr/local/lib/x86_64-linux-ghc-8.8.2"
datadir    = "/usr/local/share/x86_64-linux-ghc-8.8.2/ghctags-0.1"
libexecdir = "/usr/local/libexec/x86_64-linux-ghc-8.8.2/ghctags-0.1"
...
getDynLibDir = catchIO (getEnv "ghctags_dynlibdir") (\_ -> return dynlibdir)
