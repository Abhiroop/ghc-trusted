...
/* package compareSizes-0.1.0.0 */
#ifndef VERSION_compareSizes
#define VERSION_compareSizes "0.1.0.0"
#endif /* VERSION_compareSizes */
#ifndef MIN_VERSION_compareSizes
#define MIN_VERSION_compareSizes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_compareSizes */
...
#define CURRENT_COMPONENT_ID "compareSizes-0.1.0.0-compareSizes"
