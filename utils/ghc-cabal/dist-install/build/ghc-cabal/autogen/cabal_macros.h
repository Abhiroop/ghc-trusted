...
/* package ghc-cabal-0.1 */
#ifndef VERSION_ghc_cabal
#define VERSION_ghc_cabal "0.1"
#endif /* VERSION_ghc_cabal */
#ifndef MIN_VERSION_ghc_cabal
#define MIN_VERSION_ghc_cabal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ghc_cabal */
...
#define CURRENT_COMPONENT_ID "ghc-cabal-0.1-ghc-cabal"
